...
// Flag is the package-global bypass switch. Adapters in ressrf, httpx,
// tcpx, and sshx read it via Load to short-circuit the policy check.
// ressrftest.DisableForTests writes it (and registers a Cleanup that
// resets it) while a test runs.
